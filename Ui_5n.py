...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/screens_prefix/screens/4.jpg"))
    ...
    def click_1(self):
        ...
        self.label.setPixmap(QtGui.QPixmap(":/screens_prefix/screens/5.jpg"))
        self.pushButton_2.setEnabled(True)

    def click_2(self):
        self.pushButton_2.setEnabled(False)
        self.label.setPixmap(QtGui.QPixmap(":/screens_prefix/screens/6.jpg"))
        self.pushButton_1.setEnabled(True)
        self.pushButton_1.clicked.connect(self.click_exit)

    def click_exit(self):
        self.window_to_open = Ui_6n.Ui_MainWindow()
